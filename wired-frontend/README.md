...
| ----- |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **1. View** | Render React/HTML; stay thin; bind events and props to a use case.                                                                                                                                                    | `*.tsx`, presentational components under `components/`                                                                                                                                                             |
...
| **3. Repository** | Integrate with **application state**: TanStack Query (`useQuery` / `useMutation`), cache keys, invalidation; call adapters and shared infrastructure (`queryClient`). No raw UI. No business logic                    | `use*.ts`, hooks without the special postfixes of the other hooks (like `use*UseCase.ts`, `*Adapter.ts` and `*Logic.ts`).                                                                                          |
