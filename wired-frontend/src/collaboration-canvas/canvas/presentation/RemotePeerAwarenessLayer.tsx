...
import { colorForUserId, initialsFromAwarenessUser } from '../collaborationUser';
import { shapeWorldBoundsLoose } from '../utils/shapeWorldBounds';

/** Tip at (0,0); matches a classic arrow pointer hotspot. */
const CURSOR_PATH = 'M 0 0 L 0 16 L 5 12 L 8 19 L 10 18 L 7 9 L 12 9 Z';
  ...
  return (
    <>
      ...
      {remote.map((p) => {
        ...
        const initials = initialsFromAwarenessUser(p.user);
