...
export function useCanvasDrawing({
  ...
  }, [addShape, clientToWorld, stickyFill, stickyTextColor, shapeFill, shapeFillOpacity, onShapeCommitted]);
  ...
  const handleDrawMouseDown = useCallback(
    ...
    [tool, spaceDown, screenToWorld, addShape, attachDrawingListeners, textFill, onTextShapeCreated]
  );
