...
export function Button({
  ...
  const variants: Record<Variant, string> = {
    primary:
      'action-gradient text-on-primary px-5 py-1.5 rounded-full text-sm shadow-lg shadow-primary/20',
    secondary:
      'bg-surface-container-high text-primary px-4 py-1.5 rounded-lg text-sm hover:bg-surface-container transition-colors',
    ghost:
      'text-on-surface-variant hover:bg-surface-container-low rounded-lg px-2 py-1 text-sm',
