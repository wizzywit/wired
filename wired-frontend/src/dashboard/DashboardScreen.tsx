...
import { TemplateStrip, MobileTemplate } from '../templates';
...
export default function DashboardScreen() {
  ...
  const [workspaceSection, setWorkspaceSection] = useState<DashboardWorkspaceSection>('home');
  ...
  return (
    <div className="min-h-dvh bg-background pb-32 md:pb-12">
      ...
      {/* Desktop main */}
      <main className="hidden min-h-screen pt-14 md:block md:px-8 md:pb-12">
            ...
            <div className="lg:col-span-9">
              ...
              {workspaceSection === 'trash' ? (
                <div className="rounded-2xl border border-outline-variant/20 bg-surface-container-lowest p-8 dark:bg-surface-container">
                  <p className="text-sm text-on-surface-variant">Trash is not available yet.</p>
                </div>
              ) : null}
            </div>
          </div>
          ...
          <>
            ...
            <section className="space-y-4">
              <div className="flex items-end justify-between">
                ...
                <button
                  type="button"
                  onClick={() => setWorkspaceSection('templates')}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <MobileTemplate createPending={createPending} />
              </div>
            </section>
            <section className="space-y-4">
              <h2 className="text-sm font-bold uppercase tracking-tight text-on-surface opacity-60">
