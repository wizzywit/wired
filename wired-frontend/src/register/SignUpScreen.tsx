      ...
      <main className="flex min-h-screen flex-col md:flex-row">
        <section className="relative hidden min-h-screen w-1/2 items-center justify-center overflow-hidden bg-surface-container-low p-12 lg:w-3/5 md:flex lg:p-24">
          <div className="absolute inset-0 z-0">
            <img src={heroImg} alt="" className="h-full w-full object-cover opacity-60 mix-blend-multiply grayscale filter" />
        ...
        <section className="flex flex-1 flex-col items-center justify-center bg-surface px-6 pb-12 pt-24 md:px-12 md:py-12 lg:px-20">
          <div className="w-full max-w-md space-y-10">
            <div className="space-y-2">
              ...
              <p className="text-sm text-on-surface-variant">Start your journey into the editorial digital experience.</p>
            </div>

            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-2">
                <label htmlFor="full_name" className="block font-label text-xs uppercase tracking-widest text-on-surface-variant">
                  Full Name
                </label>
                <input
                  id="full_name"
              ...
              <div className="space-y-2">
                <label htmlFor="signup-email" className="block font-label text-xs uppercase tracking-widest text-on-surface-variant">
                  Work Email
                </label>
                <input
                  id="signup-email"
              ...
              <div className="space-y-2">
                <label htmlFor="signup-password" className="block font-label text-xs uppercase tracking-widest text-on-surface-variant">
                  Password
                </label>
            ...
            <footer className="mt-auto w-full max-w-md pt-12">
              <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
                <a href="#" className="font-label text-[10px] uppercase tracking-widest text-outline transition-colors hover:text-primary">
                  Privacy Policy
                </a>
                <a href="#" className="font-label text-[10px] uppercase tracking-widest text-outline transition-colors hover:text-primary">
                  Terms of Service
